import {type Ref, type RefObject, Suspense, useEffect, useRef, useState} from "react";
    ...
    return (
        <div className={"absolute-fill"}>
            <Canvas camera={{position: [-100, 100, -100], fov: 30 , far: 1000}}>
                <OrbitControls  target={[10, 0, 0]}   zoomToCursor zoomSpeed={2}  maxAzimuthAngle={0} ref={orbitRef}/>
                {debugMode && <Helpers/>}
