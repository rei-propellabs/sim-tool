...
import { getToken as getExistingToken, getTokenByOrgAndUser, saveLastUsedUser, setToken } from "utils/TokenManager";
...
export const MagicLink = () => {
  ...
  useEffect(() => {
    ...
    if (code && code !== "undefined" && code.length > 0) {
      const token = getTokenByOrgAndUser("uploadClient", code);
